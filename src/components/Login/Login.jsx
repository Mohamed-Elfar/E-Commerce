  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        formik.setErrors({ email: error.response?.data?.message || "Something went wrong" });
      }
    },
  });
    ...
    <>
      <form onSubmit={formik.handleSubmit}>
        <div className='container'>
          <div className="logo_container text-center">
            <img src={logo} alt="Amazon logo" className='w-50' />
          </div>
          <div className="border border-1 rounded-3 my-3 p-5">
            <h1>Sign in</h1>
            ...
            {!isEmailValid && (
              <div className="d-grid gap-2 mb-4">
                <button className="btn btn-warning" type="button" onClick={validateEmail}>
                  Continue
                </button>
              </div>
            )}
            ...
            <i className="fa-solid fa-caret-right fa-lg mx-2"></i>
      ...
      <div className="container d-flex flex-column justify-content-center align-items-center gap-3 my-4">
        <div className="top d-flex justify-content-center gap-5">
          <a href="" className='text-decoration-none'>Conditions of Use</a>
          <a href="" className='text-decoration-none'>Privacy Notice</a>
